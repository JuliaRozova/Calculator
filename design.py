...
"border: none;")
        ...
        self.btn_91 = QPushButton(self.centralwidget)
        self.btn_91.setObjectName(u"btn_91")
        sizePolicy2.setHeightForWidth(self.btn_91.sizePolicy().hasHeightForWidth())
        self.btn_91.setSizePolicy(sizePolicy2)
        self.btn_91.setCursor(QCursor(Qt.PointingHandCursor))

        self.gridLayout.addWidget(self.btn_91, 1, 2, 1, 1)
...
#endif // QT_CONFIG(shortcut)
        self.btn_91.setText(QCoreApplication.translate("MainWindow", u"9", None))
#if QT_CONFIG(shortcut)
        self.btn_91.setShortcut(QCoreApplication.translate("MainWindow", u"9", None))
#endif // QT_CONFIG(shortcut)
